/*Write a program to implement a context free grammer. The program should read the C.F.G through a file and should check whether
a string given from the the console is acceptable by the given C.F.G*/
#include<stdio.h>
#include<string.h>
#include<stdlib.h>
